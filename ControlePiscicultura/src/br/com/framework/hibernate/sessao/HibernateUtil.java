package br.com.framework.hibernate.sessao;
...
import br.com.framework.implementacao.crud.VarialvelConexaoUtil;
...
public class HibernateUtil implements Serializable {
	...
	public static String JAVA_COMP_ENV_JDBC_DATA_SOURCE = "java:/comp/env/jdbc/piscicultura";
	...
	public DataSource getDatasourceJndi() throws NamingException {
		InitialContext context = new InitialContext();
		return (DataSource) context.lookup(VarialvelConexaoUtil.JAVA_COMP_ENV_JDBC_DATA_SOURCE);
	}
